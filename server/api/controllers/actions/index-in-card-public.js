...
/**
 * @swagger
 * /public-boards/{publicId}/cards/{cardId}/actions:
 *   get:
 *     summary: Get activity of a card on a public board
 *     description: |
 *       Retrieves activity for a card belonging to a publicly shared board. Requires no
 *       authentication and is available only when the board opts into showing activity.
 *     tags:
 *       - Actions
 *     operationId: getPublicCardActions
 *     security: []
 *     parameters:
 *       - name: publicId
 *         in: path
